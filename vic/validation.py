...
if __name__ == "__main__":
    ...
    n_best_runs = 5
    config_global = _readFromFile(
        "/projects/mas1261/wp3/VIC/redriver_025/run/20191117/config.ini")  # _readFromFile(sys.argv[1]) #'_readFromFile("/projects/mas1261/wp3/VIC/machu_025/run/191001/config.ini")  #  #  _readFromFile("/projects/mas1261/wp3/VIC/machu_025/run/191001/config.ini") # #) #
