...
from cal_spotpy_functions import aggregate, read_clusters, set_interaction
from FDC_plot import flow_duration_curve
...
if __name__ == "__main__":
    ...
    n_best_runs = 5
    config_global = _readFromFile("/projects/fws1273/wp3/calibration/clusters/c1/run/test/confi_multi.ini")  # _readFromFile(sys.argv[1]) #'_readFromFile("/projects/mas1261/wp3/VIC/machu_025/run/191001/config.ini")  #  #  _readFromFile("/projects/mas1261/wp3/VIC/machu_025/run/191001/config.ini") # #) #
